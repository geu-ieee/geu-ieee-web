...
export default function ProfileCard(props) {
    return (
        <div class="flex flex-col items-center p-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-sky-600 dark:border-gray-700 dark:hover:border-transparent">
            <img class="object-cover w-32 h-32 rounded-full ring-4 ring-gray-300" src={props.pic} alt="" />

            <h1 class="mt-4 text-2xl font-semibold text-gray-700 text-center capitalize dark:text-white group-hover:text-white">{props.name}</h1>

            <p class="mt-2 text-gray-500 capitalize dark:text-gray-300 group-hover:text-gray-300 pb-2">{props.pos}</p>

            <div class="flex  mt-1  -mx-2">
            {/* absolute bottom-2  // for bottom icons at same level*/}
